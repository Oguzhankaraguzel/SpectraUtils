...
public interface INameEdit
{
    ...
    string SirNameCorrection(params string?[] sirNames);
    ...
    string FullNameCorrection(string? name, string? sirName);
    ...
    /// <param name="sirNames">The sir names to be corrected.</param>
    /// <returns>The corrected full name with proper capitalization and spacing.</returns>
    string FullNameCorrection(string?[] names, string?[] sirNames);
    ...
    string StandardizeCharacters(string? input);
